...
class _UpdateProductState extends State<UpdateProduct> {
  ...
  void initState() {
    ...
    _productType.text = widget.product.productType;
    _productdescription.text = widget.product.description;
    _price.text = widget.product.productPrice.toString();
    _discountPrice.text = widget.product.oldPrice.toString();
    selectedProductCategory = widget.product.productCategory;
    selectedProductTag = widget.product.productTag;
    images = widget.product.productImages;
    selectedColor = widget.product.colors;
